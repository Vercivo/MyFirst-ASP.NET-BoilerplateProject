...
public abstract class MyLearningProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MyLearningProjectWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyLearningProjectWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MyLearningProjectDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MyLearningProjectDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MyLearningProjectDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MyLearningProjectDbContext, Task<T>> func)
    {
        T result;
